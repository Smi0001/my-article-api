...
// configs.dbName = 'myarticle';
// configs.dbConnectionUrl = 'mongodb://' + configs.dbHost + '/' + configs.dbName;

// demo purpose
// configs.demoUrl = 'mongodb://smi:smi1234@ds153392.mlab.com:53392/filmy-dialogues';

// configs.applicationPort = 5000;
configs.dbName = 'myarticle';
configs.dbuser = 'smi';
configs.dbpassword = 'smi1234';
// configs.dbHost = 'localhost'
configs.dbConnectionUrl = `mongodb://${configs.dbuser}:${configs.dbpassword}@ds259119.mlab.com:59119/${configs.dbName}`;
...
configs.EMAIL_HOST_USER = 'support@gmail.com';
